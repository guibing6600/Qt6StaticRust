...
inline void QToolButton_setAutoExclusive(QToolButton *btn, bool on) {
    btn->setAutoExclusive(on);
}

inline void QToolButton_setIconSize(QToolButton *btn, int w, int h) {

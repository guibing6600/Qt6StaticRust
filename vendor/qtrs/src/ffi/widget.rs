unsafe extern "C++" {
    ...
    unsafe fn QWidget_setLayoutDirection(widget: *mut QWidget, dir: i32);
    ...
    // --- Click support for plain QWidget (event-filter based) ---
    unsafe fn QWidget_onClicked(widget: *mut QWidget, ctx: u64);
}
